...
button, .btn-cancel{padding:12px 20px;border-radius:6px;border:none;font-weight:600;cursor:pointer;transition:0.3s;}
button{background:var(--accent);color:#fff;}
button:hover{background:#b5935f;}
.btn-cancel{background:#777;color:#fff;text-decoration:none;display:inline-block;text-align:center;}
.btn-cancel:hover{background:#555;}
.alert{padding:10px 15px;background:#f8d7da;color:#842029;border-radius:6px;margin-bottom:20px;}
...
<div class="main">
  <div class="section-card">
    <h1><i class="fas fa-tags"></i> Add Offer-Product</h1>
    ...
    <form action="{{ route('offer_products.store') }}" method="POST">
        @csrf
        ...
        <div style="margin-top:15px;">
            ...
            <a href="{{ route('offer_products.index') }}" class="btn-cancel"><i class="fas fa-times"></i> Cancel</a>
        </div>
    </form>
  </div>
</div>

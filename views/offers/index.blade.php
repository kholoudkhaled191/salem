...
.section-card{margin-bottom:30px;background:white;border-radius:var(--card-border-radius);box-shadow:0 5px 15px rgba(0,0,0,0.05);padding:25px;max-width:1100px;margin-left:auto;margin-right:auto;}
...
.add-btn{display:inline-block;margin-bottom:20px;padding:10px 20px;background:var(--accent);color:#fff;border-radius:8px;text-decoration:none;font-weight:600;transition:0.3s;}
.add-btn:hover{background:#b5935f;}
...
.btn{font-size:14px;padding:6px 12px;border-radius:6px;text-decoration:none;cursor:pointer;transition:0.3s;border:none;}
.btn-warning{background:#f39c12;color:#fff;}
.btn-warning:hover{background:#d68910;}
.btn-danger{background:#e74c3c;color:#fff;}
.btn-danger:hover{background:#c0392b;}
.alert-success{background:#2ecc71;color:#fff;padding:10px 15px;border-radius:6px;margin-bottom:20px;}
</style>
</head>
<body>
...
<div class="main">
  <div class="section-card">
    <h1><i class="fas fa-gift"></i> Offers List</h1>
    <a href="{{ route('offers.create') }}" class="add-btn"><i class="fas fa-plus"></i> Add New Offer</a>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $offer->end_at }}</td>
                <td>
                    <a href="{{ route('offers.edit', $offer->id) }}" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>

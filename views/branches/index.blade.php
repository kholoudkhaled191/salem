...
<title>Branches Dashboard</title>
...
.card h3{font-size:18px;font-weight:600;color:var(--primary);margin-bottom:10px;}
.card p{color:var(--text-light);margin-bottom:15px;}
.card .actions{display:flex;gap:10px;}
.card .actions a, .card .actions button{padding:6px 12px;border-radius:6px;border:none;cursor:pointer;font-size:14px;font-weight:500;text-decoration:none;transition:0.3s;}
.card .actions a{background:#3498db;color:#fff;}
.card .actions a:hover{background:#2980b9;}
.card .actions button{background:#e74c3c;color:#fff;}
.card .actions button:hover{background:#c0392b;}
.add-branch{display:inline-block;margin-bottom:20px;padding:10px 20px;background:var(--accent);color:#fff;border-radius:8px;text-decoration:none;font-weight:600;transition:0.3s;}
.add-branch:hover{background:#b5935f;}
</style>
</head>
<body>
...
<div class="main">
  <h1>Branches List</h1>
  <a href="{{ route('branches.create') }}" class="add-branch"><i class="fas fa-plus"></i> Add Branch</a>
  ...
  <div class="grid">
    @foreach($branches as $branch)
      <div class="card">
        ...
        <div class="actions">
          <a href="{{ route('branches.edit', $branch->id) }}"><i class="fas fa-edit"></i> Edit</a>
